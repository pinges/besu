...
public class PrivacyAccountResolver {
  ...
  public static final PrivacyAccount MULTI_TENANCY =
          PrivacyAccount.create(
                  resolveResource("key"),
                  new URL[] {resolveResource("orion_key_0.pub"), resolveResource("orion_key_1.pub"), resolveResource("orion_key_2.pub")},
                  new URL[] {resolveResource("orion_key_0.key"), resolveResource("orion_key_1.key"), resolveResource("orion_key_2.key")});
