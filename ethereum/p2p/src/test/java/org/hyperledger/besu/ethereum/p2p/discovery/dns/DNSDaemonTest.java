...
class DNSDaemonTest {
  ...
  // dns-records.json is regenerated by go-ethereum's dnsdisc from the same 115 ENRs, so every
  // subtree label is a real keccak256 hash of its content and the root signature verifies. That
  // makes the fixture signed by a throwaway key rather than the live ethdisco.net publisher.
  private static final String holeskyEnr =
      "enrtree://APFGGTFOBVE2ZNAB3CSMNNX6RRK3ODIRLP2AA5U4YFAA6MSYZUYTQ@all.holesky.ethdisco.net";
