...
public class BlockAccessListJsonRpcHttpBySpecTest extends AbstractJsonRpcHttpBySpecTest {
  ...
  public static Object[][] specs() {
    return findSpecFiles(new String[] {"eth/block-access-list", "debug/block-access-list"});
  }
}
