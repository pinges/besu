...
public class BlockAccessListPreAmsterdamJsonRpcHttpBySpecTest
    extends AbstractJsonRpcHttpBySpecTest {
  ...
  public static Object[][] specs() {
    return findSpecFiles(
        new String[] {
          "eth/block-access-list-pre-amsterdam", "debug/block-access-list-pre-amsterdam"
        });
  }
}
